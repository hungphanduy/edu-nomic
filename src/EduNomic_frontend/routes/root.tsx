...
import { createActor, EduNomic_backend_dao } from 'declarations/EduNomic_backend_dao';
...
export default function Root() {
  ...
  async function login() {
    ...
    if (!process.env.CANISTER_ID_EDUNOMIC_BACKEND_DAO) {
    ...
    actor = createActor(process.env.CANISTER_ID_EDUNOMIC_BACKEND_DAO, {
      agent,
    });
