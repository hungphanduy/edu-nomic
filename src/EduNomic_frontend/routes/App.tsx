  ...
  return (
    ...
    >
      ...
      <Text color={'gray.500'} maxW={'3xl'}>
        Learn, analyze, and grow with a supportive community of economics students and professionals.
        Participate in discussions, work on economic research, and deepen your
        understanding of markets and financial systems. Economic education, mentorship, and continuous
        learning start here.
      </Text>
