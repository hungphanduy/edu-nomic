...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Courses', icon: FaUserAstronaut, to: '/dashboard/projects' },
];
      ...
      try {
        ...
        if (response.ok == null) {
          ...
          toast({
            ...
            description: 'You are now a member of EconomicsUnited.',
            status: 'success',
            duration: 9000,
            isClosable: true,
            position: 'top',
    ...
    <Box minH="100vh" bg={useColorModeValue('gray.100', 'gray.900')}>
      ...
      <Modal isOpen={isOpenModal} onClose={onCloseModal}>
        ...
        <ModalContent>
          ...
          <ModalBody>
            <Text mb={5}>
              Provide your name and LinkedIn profile to become an EconomicsUnited
              member.
            </Text>
